...
function init() {
    ...
    document.getElementById("alertLevel").innerHTML = localStorage.lsAlertLevel + "°C";
...
function drawTempChart(){
    tempChartContainer = document.getElementById('canvasTempChart');
    ...
    tempChart = new Chart(tempChartContainer, {
...
function drawPerformanceChart(){
    performanceChartContainer = document.getElementById('canvasPerformanceChart');
    ...
    performChart = new Chart(performanceChartContainer, {
    type:'line', // bar, horizontalBar, pie, line, doughnut, radar, polarArea
    data:{
        labels: temperatureChart.timeLine,
        datasets:[{
...
var machineServer = {
    ...
    "getData": function (dataURL) {
        ...
        serverCommunication.addEventListener("load", function () {
           ...
           var performanceValueDisplay = document.getElementById("performanceValue");
           ...
           switch(selectedMachine){
            case "nodeMachine1":
                ...
                tempValueDisplay.innerHTML = arrMainInformation.machine1[1] + "C";
                mRuntime.innerHTML = arrMainInformation.machine1[2];
                ePower.innerHTML = arrMainInformation.machine1[3];
                performanceValueDisplay.innerHTML = arrMainInformation.machine1[3];
            ...
            case "nodeMachine2":
                ...
                tempValueDisplay.innerHTML = arrMainInformation.machine2[1] + "C";
                mRuntime.innerHTML = arrMainInformation.machine2[2];
                ePower.innerHTML = arrMainInformation.machine2[3];
                performanceValueDisplay.innerHTML = arrMainInformation.machine2[3];
            ...
            case "nodeMachine3":
                ...
                tempValueDisplay.innerHTML = arrMainInformation.machine3[1] + "C";
                mRuntime.innerHTML = arrMainInformation.machine3[2];
                ePower.innerHTML = arrMainInformation.machine3[3];
                performanceValueDisplay.innerHTML = arrMainInformation.machine3[3];
            ...
            case "nodeMachine4":
                ...
                tempValueDisplay.innerHTML = arrMainInformation.machine4[1] + "C";
                mRuntime.innerHTML = arrMainInformation.machine4[2];
                ePower.innerHTML = arrMainInformation.machine4[3];
                performanceValueDisplay.innerHTML = arrMainInformation.machine4[3];
            ...
            case "nodeMachine5":
                ...
                tempValueDisplay.innerHTML = arrMainInformation.machine5[1] + "C";
                mRuntime.innerHTML = arrMainInformation.machine5[2];
                ePower.innerHTML = arrMainInformation.machine5[3];
                performanceValueDisplay.innerHTML = arrMainInformation.machine5[3];
            ...
            var alertLevel = localStorage.lsAlertLevel;
            var currentTemperatureValue = document.getElementById("tempValue").innerHTML;
            var currentTemperature = currentTemperatureValue.replace("°C", "");
        
            if (currentTemperature >= alertLevel){
                tempDisplay.style.borderColor = "red";
            }else{
                tempDisplay.style.borderColor = "grey";
            };
...
function closeModal(){
    ...
    localStorage.setItem("lsAlertLevel", inputValue.value);
};
...
function temperatureWatchdog(){
    let alertLevel = localStorage.lsAlertLevel;
    let currentTemperature = mTemperature.innerHTML.replace("°", "");
